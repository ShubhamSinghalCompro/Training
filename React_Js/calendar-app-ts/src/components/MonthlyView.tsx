          ...
          <Grid item xs={12 / 7} key={index}>
            <Box
              sx={{
                ...
                position: 'relative',
                cursor: selectedDate.getMonth() !== day.getMonth() ? 'not-allowed' : 'pointer',
                '&:hover': {
                  backgroundColor: theme.palette.action.selected, // Hover color from theme
                },
                opacity: selectedDate.getMonth() !== day.getMonth() ? 0.5 : 1,
              }}
              onClick={() => selectedDate.getMonth() !== day.getMonth() ? null : openModal(null, day)}
            >
              {/* Display the date */}
